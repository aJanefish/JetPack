...
public class MainViewModel extends ViewModel {
    ...
    public void startTiming() {
        if (timer == null) {
            ...
            TimerTask timerTask = new TimerTask() {
                ...
                public void run() {
                    currentSecond++;
                    Log.d(TAG, "" + onTimeChangeListener + " " + currentSecond);
                    if (onTimeChangeListener != null) {
                        onTimeChangeListener.onTimeChanged(onTimeChangeListener.hashCode() + " # " + currentSecond);
                    }
                }
            };
    ...
    public interface OnTimeChangeListener {
        void onTimeChanged(String second);
    }
